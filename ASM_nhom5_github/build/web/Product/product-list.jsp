<%-- 
    ...
    Created on : Feb 10, 2026, 3:17:40 PM
    Author     : ntpho
--%>
...
<body>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb-3">
            ...
            <div>
                <a href="products?action=listSuppliers" class="btn btn-outline-primary mr-2">Quản lý Nhà Cung Cấp</a>
        
                <a href="products?action=new" class="btn btn-success font-weight-bold">+ Nhập loại hàng mới</a>
            </div>
        </div>
        ...
        <table class="table table-bordered table-hover">
            <thead class="thead-light">
                <tr>
                    ...
                    <th>Giá Nhập</th>
                    <th>Giá Bán</th>
                    <th>Trạng thái</th> <th style="width: 250px;">Hành động</th>
                </tr>
            </thead>
            <tbody>
                <c:forEach var="p" items="${listProducts}">
                    <tr style="${p.isActive ? '' : 'background-color: #f2f2f2; color: #888;'}">
                        ...
                        <td>
                            <c:if test="${p.isActive}">
                                <a href="products?action=edit&id=${p.productID}" class="btn btn-sm btn-info" title="Sửa tên/giá bán">Sửa</a>
        
                                <a href="products?action=import&id=${p.productID}" class="btn btn-sm btn-success" title="Nhập thêm hàng">Nhập</a>
